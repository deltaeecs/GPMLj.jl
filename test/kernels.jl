...
using GPnet
using GPnet: ZeroKernel, OneKernel, ConstKernel, pw, EQ, PerEQ, Exp, Matern32,
    Matern52, RQ, Cosine, Linear, Poly, GammaExp, Wiener, WienerVelocity,
    Noise, Precomputed, Sum, Product, Scaled, Stretched, stretch
using LinearAlgebra
